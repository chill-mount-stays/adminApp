  ...
  return (
    <div className="flex gap-5 lg:gap-4 flex-col">
      {navLinks.map((link, idx) => (
        <Link key={"link__" + idx} className={`text-xs lg:text-sm md:text-sm pl-4 py-2 rounded-full hover:border hover:bg-zinc-100  font-medium ${pathname === link.url ? "text-white bg-zinc-800 hover:bg-zinc-600" : "text-black"}`} href={link.url}>
